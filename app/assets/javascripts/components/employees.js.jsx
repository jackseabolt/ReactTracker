          ...
          <div id="employees">
            <table className="table table-striped">
              ...
              <tbody>
                ...
                <tr>
                  <td>
                    <input type="text" value={this.state.employee.name} onChange={this.handleNameChange} className="form-control" /><br />
                    <span style={{color: 'red'}}>{this.state.errors.name}</span>
                  </td>
                  <td>
                    <input value={this.state.employee.email} type="text" onChange={this.handleEmailChange} className="form-control" /><br />
